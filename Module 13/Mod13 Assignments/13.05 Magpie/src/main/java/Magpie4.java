...
public class Magpie4 {
    ...
    public String getResponse(String statement) {
        ...
        // Responses which require transformations
            ...
            int psn = findKeyword(statement, "I");
    ...
    /**
     * Transforms a statement with "I want <something>" into "Would you really
     * be happy if you had <something>?"
     *
     * @param statement
     *            the user statement containing "I want"
     * @return the transformed statement
     */
    ...
    /**
     * Transforms the statement "I <something> you" into "Why do you <something>
     * me?"
     *
     * @param statement
     *            the user statement containing "I <something> you"
     * @return the transformed statement
     */
    ...
    private String getRandomResponse() {
        ...
        String[] possibleResponses = { "Interesting, tell me more.", "Hmmm.", "Do you really think so?",
                                       "You don't say.", "Really?", "I haven't heard that one before.", "Ok", "How fascinating."};
        int whichResponse = (int) (r * possibleResponses.length);
        return possibleResponses[whichResponse];
    }
