...
public class CurrencyConversionV1
{
    public static void main(String [ ] args)
    {
        ...
        double pesoExchangeRate = 18.49225;     // local variable for exchange rate of US Dollars to pesos
        ...
        double yenExchangeRate = 102.1920;      // local variab;e for exchange rate of US dollars to yen
        ...
        double euroExchangeRate = 0.897350;     // local variable for exchange rate of US dollars to euros
